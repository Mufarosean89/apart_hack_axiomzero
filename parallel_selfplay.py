...
class ParallelSelfPlay:
    ...
    def __init__(
        ...
        logger.info(f"Initialized parallel self-play with {self.num_workers} workers")
    ...
    def generate_games(
        ...
        logger.info(f"Generating {len(tasks)} games with {self.num_workers} workers")
    ...
    def generate_batch(
        ...
        for batch_idx in range(batches):
            ...
            # Generate batch
            batch_results = self.generate_games(batch_theorems, games_per_theorem=10)
...
class DistributedReplayBuffer:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        with self.lock:
            ...
            avg_reward = sum(g['total_reward'] for g in self.buffer) / len(self.buffer)
