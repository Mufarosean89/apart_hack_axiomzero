...
class PyTorchModelParser:
            ...
            if isinstance(stmt, ast.Assign):
                for target in stmt.targets:
                    if isinstance(target, ast.Attribute) and target.value.id == 'self':
                        ...
                        layer_info = self._extract_layer(
                            stmt.value, layer_name)
                        if layer_info:
    ...
    def compute_shapes(self, input_shape: List[int]):
        ...
        for layer in self.model_ir.layers:
            ...
            if layer.layer_type == 'Linear':
                in_features = layer.parameters.get(
                    'in_features', layer.parameters.get('arg_0'))
                out_features = layer.parameters.get(
                    'out_features', layer.parameters.get('arg_1'))
                ...
                out_channels = layer.parameters.get(
                    'out_channels', layer.parameters.get('arg_1'))
                kernel_size = layer.parameters.get(
                    'kernel_size', layer.parameters.get('arg_2', 3))
                ...
                if out_channels:
                    ...
                    current_shape = [current_shape[0], out_channels,
    ...
    def count_parameters(self):
        ...
        for layer in self.model_ir.layers:
            if layer.layer_type == 'Linear':
                in_features = layer.parameters.get(
                    'in_features', layer.parameters.get('arg_0', 0))
                out_features = layer.parameters.get(
                    'out_features', layer.parameters.get('arg_1', 0))
                ...
                in_channels = layer.parameters.get(
                    'in_channels', layer.parameters.get('arg_0', 0))
                out_channels = layer.parameters.get(
                    'out_channels', layer.parameters.get('arg_1', 0))
                kernel_size = layer.parameters.get(
                    'kernel_size', layer.parameters.get('arg_2', 3))
