...
def main():
    ...
    try:
        ...
        ir = parse_to_ir(code)
        print(f"   ✓ Parsed: {ir.total_functions} functions, {ir.total_loops} loops")
    ...
    try:
        ...
        print(f"   ✓ Holes: {skeleton.total_holes} ({skeleton.simple_holes} simple, {skeleton.complex_holes} complex)")
    ...
    print(f"   • Simple holes ({skeleton.simple_holes}): Auto-fill with simp/ring/omega")
    print(f"   • Complex holes ({skeleton.complex_holes}): Require MCTS + RL agent")
    print()
